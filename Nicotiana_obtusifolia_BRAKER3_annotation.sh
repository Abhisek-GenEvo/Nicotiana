...
#SBATCH -J NO_BRAKER3            # Job name
#SBATCH -o NO_BRAKER3.%j.out       # Specify stdout output file (%j expands to jobId)
...
braker.pl --genome=/lustre/project/m2_jgu-evoltroph/achakrab/NO_genome/02_Assembly_files/NO_genome_masked.fasta --species=obtusifolia --softmasking --threads 20 --rnaseq_sets_ids=NO --rnaseq_sets_dir=/lustre/project/m2_jgu-evoltroph/achakrab/NO_genome/04_RNAseq_files/filtered_files --prot_seq=/lustre/project/m2_jgu-evoltroph/achakrab/NA_genome/05_protein_files/Selected_Solanaceae_species_cat.fasta --workingdir=/lustre/project/m2_jgu-evoltroph/achakrab/NO_genome/03_BRAKER_analysis/NO_BRAKER3_output --AUGUSTUS_CONFIG_PATH=$AUGUSTUS_CONFIG_PATH --PYTHON3_PATH=$PYTHON3_PATH --PROTHINT_PATH=/lustre/project/m2_jgu-evoltroph/achakrab/SOFTWARES/ProtHint-2.6.0/bin --GENEMARK_PATH=/lustre/project/m2_jgu-evoltroph/achakrab/SOFTWARES/gmetp_linux_64/bin
